...
export class CanvasDropHandler {
    static onDrop(event) {
        ...
        /* Reorder: drag handles set 'dragged-component-id' instead of
           ...
           container. */
        const draggedId = (_b = event.dataTransfer) === null || _b === void 0 ? void 0 : _b.getData('dragged-component-id');
        if (draggedId) {
        ...
        const componentType = (_c = event.dataTransfer) === null || _c === void 0 ? void 0 : _c.getData('component-type');
        let customSettings = (_d = event.dataTransfer) === null || _d === void 0 ? void 0 : _d.getData('custom-settings');
        if (!componentType)
            return;
        ...
        if (!customSettings || customSettings.trim() === '') {
            ...
            if (draggableElement) {
                ...
                if ((_e = customComponents === null || customComponents === void 0 ? void 0 : customComponents[componentType]) === null || _e === void 0 ? void 0 : _e.settings) {
        ...
        if (component && CanvasSharedState.editable !== false) {
            ...
            if (layoutMode === 'grid') {
                const insertBefore = CanvasSharedState.gridManager.findInsertionPoint(event, canvasElement);
