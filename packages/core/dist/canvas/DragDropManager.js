    ...
    enable() {
        ...
        draggableItems.forEach(item => {
            item.addEventListener('dragstart', event => {
                ...
                (_a = dragEvent.dataTransfer) === null || _a === void 0 ? void 0 : _a.setData('component-type', item.id);
                const settingsData = item.getAttribute('data-component-settings');
                if (settingsData) {
                    (_b = dragEvent.dataTransfer) === null || _b === void 0 ? void 0 : _b.setData('custom-settings', settingsData);
                }
            });
        });
    }
