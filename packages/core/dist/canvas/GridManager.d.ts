export declare class GridManager {
    ...
    initializeDropPreview(canvasElement: HTMLElement, layoutMode?: LayoutMode): void;
    /**
     ...
     */
    findInsertionPoint(event: DragEvent, canvasElement: HTMLElement): HTMLElement | null;
