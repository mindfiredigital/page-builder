export declare class HeaderComponent {
    ...
    constructor();
    create(level?: number, text?: string, headerAttributeConfig?: ComponentAttribute[] | undefined): HTMLElement;
    seedFormulaValues(values: AttributeValues): void;
    updateInputValues(values: AttributeValues): void;
    updateHeaderContent(headerElement: HTMLElement, attribute: ComponentAttribute): void;
