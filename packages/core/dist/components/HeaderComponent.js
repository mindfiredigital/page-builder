...
export class HeaderComponent {
    ...
    static restore(container) {
        ...
        if (closestHeader && headerText) {
            ...
            if (attributeKey) {
                const attribute = HeaderComponent.headerAttributeConfig.find(attr => attr.key === attributeKey);
                if (attribute) {
                    const controlsElement = closestHeader.querySelector('.component-controls');
