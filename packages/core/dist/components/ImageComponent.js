...
export class ImageComponent {
    create(src = null, imageAttributeConfig) {
        ...
        fileInput.addEventListener('change', event => ImageComponent.handleFileChange(event, container, uploadText));
                ...
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (imageElement) {
                        if (ImageComponent.imageAttributeConfig) {
                            const result = yield ImageComponent.imageAttributeConfig(base64String);
    ...
    static restoreImageUpload(component, src, editable) {
        ...
        fileInput.addEventListener('change', event => this.handleFileChange(event, component, uploadText));
        pencilButton.addEventListener('click', () => fileInput.click());
