export class LinkComponent {
    ...
    getLinkData() {
        var _a, _b, _c;
        return {
            href: ((_a = this.link) === null || _a === void 0 ? void 0 : _a.href) || '#',
            label: ((_b = this.link) === null || _b === void 0 ? void 0 : _b.innerText) || 'Click Here',
            target: ((_c = this.link) === null || _c === void 0 ? void 0 : _c.target) || '_self',
        };
    }
    /**
    ...
    static restore(container) {
        ...
        (_a = editButton.parentNode) === null || _a === void 0 ? void 0 : _a.replaceChild(newEditButton, editButton);
        (_b = saveButton.parentNode) === null || _b === void 0 ? void 0 : _b.replaceChild(newSaveButton, saveButton);
