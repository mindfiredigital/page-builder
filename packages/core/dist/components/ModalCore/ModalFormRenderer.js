...
export function toggleFieldExpansion(attrId, modalRoot) {
    ...
    const valueContainer = headerContainer === null || headerContainer === void 0 ? void 0 : headerContainer.nextElementSibling;
    const expandIcon = headerContainer === null || headerContainer === void 0 ? void 0 : headerContainer.querySelector('.expand-icon');
    if (valueContainer && expandIcon) {
        /* Toggle direction: collapse if expanded, expand if collapsed */
        const isExpanded = !valueContainer.classList.contains('form-value-collapsed');
        if (isExpanded) {
...
export function filterAttributes(query, contentContainer) {
    ...
    contentContainer.querySelectorAll('.form-field').forEach(field => {
        var _a, _b, _c;
        const key = (_a = field.getAttribute('data-attr-key')) === null || _a === void 0 ? void 0 : _a.toLowerCase();
        const title = (_c = (_b = field
            .querySelector('.form-title')) === null || _b === void 0 ? void 0 : _b.textContent) === null || _c === void 0 ? void 0 : _c.toLowerCase();
        /* Show if either the key or title contains the search query */
        if ((key === null || key === void 0 ? void 0 : key.includes(normalizedQuery)) || (title === null || title === void 0 ? void 0 : title.includes(normalizedQuery))) {
