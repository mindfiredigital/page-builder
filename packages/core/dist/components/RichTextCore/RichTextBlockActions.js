import { createBlockContent, createChecklistItem, createHeadingContent, createListContent, } from './RichTextBlockCreators.js';
    ...
    switch (fromType) {
        case 'list':
            return Array.from(content.querySelectorAll('li'))
                .map(li => { var _a, _b; return (_b = (_a = li.textContent) === null || _a === void 0 ? void 0 : _a.trim()) !== null && _b !== void 0 ? _b : ''; })
                .filter(Boolean)
                .join('\n');
        case 'quote':
            return (_c = (_b = (_a = content.querySelector('.rt-quote-text')) === null || _a === void 0 ? void 0 : _a.textContent) === null || _b === void 0 ? void 0 : _b.trim()) !== null && _c !== void 0 ? _c : '';
        case 'checklist':
            return Array.from(content.querySelectorAll('.rt-checklist-text'))
                .map(el => { var _a, _b; return (_b = (_a = el.textContent) === null || _a === void 0 ? void 0 : _a.trim()) !== null && _b !== void 0 ? _b : ''; })
                .filter(Boolean)
                .join('\n');
        case 'warning': {
            const t = (_f = (_e = (_d = content.querySelector('.rt-warning-title')) === null || _d === void 0 ? void 0 : _d.textContent) === null || _e === void 0 ? void 0 : _e.trim()) !== null && _f !== void 0 ? _f : '';
            const m = (_j = (_h = (_g = content.querySelector('.rt-warning-message')) === null || _g === void 0 ? void 0 : _g.textContent) === null || _h === void 0 ? void 0 : _h.trim()) !== null && _j !== void 0 ? _j : '';
            return [t, m].filter(Boolean).join('\n');
        }
        default:
            return (_l = (_k = content.textContent) === null || _k === void 0 ? void 0 : _k.trim()) !== null && _l !== void 0 ? _l : '';
    }
}
export function injectTextIntoBlock(content, toType, text) {
    ...
    switch (toType) {
        ...
        default: {
            const editable = (_b = content.querySelector('[contenteditable="true"]')) !== null && _b !== void 0 ? _b : (content.getAttribute('contenteditable') === 'true' ? content : null);
            if (editable)
...
export function convertBlock(block, toType) {
    ...
    const fromType = (_a = block.dataset.blockType) !== null && _a !== void 0 ? _a : 'text';
    const preservedText = extractBlockText(oldContent, fromType);
    const newContent = createBlockContent(toType);
    oldContent === null || oldContent === void 0 ? void 0 : oldContent.replaceWith(newContent);
...
export function changeHeadingLevel(block, level) {
    ...
    const preservedText = (_b = (_a = oldHeading === null || oldHeading === void 0 ? void 0 : oldHeading.textContent) === null || _a === void 0 ? void 0 : _a.trim()) !== null && _b !== void 0 ? _b : '';
    const newHeading = createHeadingContent(level);
    if (preservedText)
        newHeading.textContent = preservedText;
    oldHeading === null || oldHeading === void 0 ? void 0 : oldHeading.replaceWith(newHeading);
}
export function toggleImageOption(block, option) {
    ...
    switch (option) {
        case 'border':
            if (img)
                img.style.border = isOn ? '' : '3px solid #e2e8f0';
            break;
        case 'stretch':
            if (img)
                img.style.width = isOn ? '' : '100%';
            break;
        case 'background':
...
export function toggleListStyle(block, style) {
    ...
    if (!oldList)
        return;
    const texts = Array.from(oldList.querySelectorAll('li')).map(li => { var _a, _b; return (_b = (_a = li.textContent) === null || _a === void 0 ? void 0 : _a.trim()) !== null && _b !== void 0 ? _b : ''; });
...
export function moveBlockUp(block, root) {
    const siblings = Array.from(root.children).filter(el => el.classList.contains('rt-block'));
