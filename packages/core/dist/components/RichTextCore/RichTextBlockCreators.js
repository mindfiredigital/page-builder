...
export function createHeadingContent(level) {
...
export function createImageContent() {
    ...
    fileInput.addEventListener('change', () => {
        ...
        reader.onload = ev => {
            ...
            img.src = (_a = ev.target) === null || _a === void 0 ? void 0 : _a.result;
...
export function createListContent(style) {
...
export function createQuoteContent() {
    const wrapper = document.createElement('div');
...
export function createDelimiterContent() {
    const div = document.createElement('div');
...
export function createRawHtmlContent() {
    const wrapper = document.createElement('div');
...
export function createWarningContent() {
    const wrapper = document.createElement('div');
...
export function createChecklistContent() {
    const wrapper = document.createElement('div');
    ...
    wrapper.addEventListener('keydown', (e) => {
        ...
        if (e.key === 'Enter' && target.classList.contains('rt-checklist-text')) {
            ...
            (_a = newItem.querySelector('.rt-checklist-text')) === null || _a === void 0 ? void 0 : _a.focus();
        }
    });
    return wrapper;
}
export function createBlockContent(type) {
    switch (type) {
        case 'heading':
