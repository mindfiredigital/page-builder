import { RICH_TEXT_BLOCK_TYPES, RICH_TEXT_TUNE_ICONS } from '../../constants/index.js';
...
export function buildTuneItem(item, callbacks) {
    if (item.submenu)
        return buildSubmenuItem(item, callbacks);
    const el = document.createElement('div');
    el.classList.add('rt-popover-item');
    if (item.danger)
        el.classList.add('rt-popover-item--danger');
    if (item.active)
        el.classList.add('rt-popover-item--active');
...
export function buildSubmenuItem(item, callbacks) {
    ...
    el.addEventListener('mouseenter', () => {
        ...
        callbacks.showSubmenu((_a = item.submenu) !== null && _a !== void 0 ? _a : [], el);
    });
...
export function getBlockSpecificTunes(block, blockType, actions) {
    ...
    switch (blockType) {
        ...
        case 'heading': {
            ...
            const currentLevel = parseInt((_a = headingEl === null || headingEl === void 0 ? void 0 : headingEl.dataset.level) !== null && _a !== void 0 ? _a : '2', 10);
        ...
        case 'code': {
            ...
            const currentTheme = (_b = codeWrapper === null || codeWrapper === void 0 ? void 0 : codeWrapper.dataset.theme) !== null && _b !== void 0 ? _b : 'light';
            return [
                {
                    label: 'Light mode',
                    icon: icons.sun,
        ...
        case 'list': {
            ...
            const currentStyle = (_c = listEl === null || listEl === void 0 ? void 0 : listEl.dataset.listStyle) !== null && _c !== void 0 ? _c : 'unordered';
            return [
                {
                    label: 'Unordered',
            ...
            return [
                {
                    ...
                    active: (imageBlock === null || imageBlock === void 0 ? void 0 : imageBlock.dataset.border) === 'true',
                    action: () => actions.toggleImageOption(block, 'border'),
                },
                {
                    label: 'Stretch image',
                    icon: icons.imgStretch,
                    active: (imageBlock === null || imageBlock === void 0 ? void 0 : imageBlock.dataset.stretch) === 'true',
                    action: () => actions.toggleImageOption(block, 'stretch'),
                },
                {
                    label: 'With background',
                    icon: icons.imgBackground,
                    active: (imageBlock === null || imageBlock === void 0 ? void 0 : imageBlock.dataset.background) === 'true',
        ...
        case 'quote': {
            const currentAlign = (_d = block.dataset.align) !== null && _d !== void 0 ? _d : 'left';
            return [
                {
                    label: 'Align Left',
                    icon: icons.alignLeft,
