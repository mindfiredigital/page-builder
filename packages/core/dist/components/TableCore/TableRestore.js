...
export function Restore(container, editable, tableAttributeConfig) {
    ...
    const closestTable = tableWrapper === null || tableWrapper === void 0 ? void 0 : tableWrapper.closest('.table-component');
    const tableId = closestTable === null || closestTable === void 0 ? void 0 : closestTable.id;
    if (!tableWrapper) {
    ...
    cells.forEach(cell => {
        ...
        if (textContentOfCell === null || textContentOfCell === void 0 ? void 0 : textContentOfCell.classList.contains('selected')) {
            textContentOfCell.classList.remove('selected');
        }
        if (attributeKey && textContentOfCell) {
            const attribute = tableAttributeConfig.find(attr => attr.key === attributeKey);
            if (attribute) {
        ...
        if (editable === false) {
            ...
            textContentOfCell === null || textContentOfCell === void 0 ? void 0 : textContentOfCell.removeAttribute('contenteditable');
            return;
        }
        if (controls) {
    ...
    const addMultipleRowsButton = container.querySelector('.add-multiple-rows-button');
