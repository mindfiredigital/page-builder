...
export function wireSidebarMenuToggle(button) {
    ...
    button.onclick = () => {
        ...
        const hasClass = sidebar === null || sidebar === void 0 ? void 0 : sidebar.classList.contains('visible');
        if (sidebar) {
            if (hasClass) {
...
export function wireMenuButtonToggle(button) {
    button.onclick = () => {
        ...
        const hasClass = customizeTab === null || customizeTab === void 0 ? void 0 : customizeTab.classList.contains('visible');
        if (customizeTab) {
            if (hasClass) {
