...
import { buildTabToggle, switchToCustomizeMode, switchToAttributeMode, populateCssControls, handleInputTrigger, populateFunctionalityControls, addControlListeners, } from './CustomizationSidebarCore/index.js';
export class CustomizationSidebar {
    ...
    static getCustomizeTagForComponent(component) {
        ...
        if (!component.classList.contains('custom-component'))
            return undefined;
        if (!this.customComponentsConfig)
            return undefined;
        const componentType = (_a = Array.from(component.classList)
            .find(cls => cls.endsWith('-component') && cls !== 'custom-component')) === null || _a === void 0 ? void 0 : _a.replace('-component', '');
        if (!componentType)
            return undefined;
        return (_b = this.customComponentsConfig[componentType]) === null || _b === void 0 ? void 0 : _b.customizeComponentTagName;
    }
    ...
    static populateCssControlsLocal(component) {
        ...
        populateCssControls(component, this.controlsContainer, c => addControlListeners(c, this.controlsContainer, cc => this.populateCssControlsLocal(cc), customizeTag), customizeTag);
    }
    /* Thin wrapper that passes all required state into the module function */
    static populateFunctionalityControlsLocal(component) {
        populateFunctionalityControls(component, this.functionsPanel, this.basicComponentsConfig, this.customComponentsConfig, this.editable, _event => handleInputTrigger(this.selectedComponent, this.basicComponentsConfig, this.functionsPanel));
    }
