...
export function handleInputTrigger(selectedComponent, basicComponentsConfig, functionsPanel) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (selectedComponent.classList.contains('table-component')) {
            componentConfig = basicComponentsConfig === null || basicComponentsConfig === void 0 ? void 0 : basicComponentsConfig.find(c => c.name === 'table');
        }
        ...
        if (!(componentConfig === null || componentConfig === void 0 ? void 0 : componentConfig.globalExecuteFunction))
            return;
