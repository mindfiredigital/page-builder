...
} from '../../components/ModalCore/index.js';
...
describe('handleSave', () => {
  ...
  it('should resolve with empty object when selected attribute has undefined value', () => {
    const attrs = [{ id: 'a1', key: 'noVal', title: 'NoVal', type: 'Input' }];
...
describe('ModalComponent', () => {
  ...
  it('close button click should resolve promise with null', () =>
  ...
  it('save button click should resolve promise with selected field', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const modal = new ModalComponent();
      const promise = modal.show(SAMPLE_ATTRS);
