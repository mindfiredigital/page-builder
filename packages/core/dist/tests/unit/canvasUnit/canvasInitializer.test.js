import { CanvasInitializer } from '../../../canvas/CanvasCore/CanvasInitializer.js';
import { CanvasSharedState } from '../../../canvas/CanvasCore/CanvasSharedState.js';
import { CanvasStateManager } from '../../../canvas/CanvasCore/CanvasStateManager.js';
...
describe('CanvasInitializer', () => {
    ...
    describe('State Restoration Logic', () => {
        it('should restore state from initialData if provided', () => {
            const fakeData = { version: '1.0', components: [] };
    ...
    it('should initialize services and managers', () => {
        ...
        expect(CanvasSharedState.gridManager.initializeDropPreview).toHaveBeenCalledWith(mockCanvas);
    });
});
