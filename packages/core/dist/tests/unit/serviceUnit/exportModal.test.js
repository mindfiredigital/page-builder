import { createExportModal, closeModal, createCloseButton, createCodeSection, } from '../../../services/ExportModalService.js';
...
describe('ExportModalService', () => {
    ...
    describe('createExportModal', () => {
        it('should create a modal with the correct ID and sections', () => {
            ...
            expect((_a = modal.querySelector('h2')) === null || _a === void 0 ? void 0 : _a.textContent).toBe('HTML');
        });
        it('should contain a contenteditable code block with highlighted content', () => {
            ...
            expect(codeBlock === null || codeBlock === void 0 ? void 0 : codeBlock.getAttribute('contenteditable')).toBe('true');
            expect(codeBlock === null || codeBlock === void 0 ? void 0 : codeBlock.innerHTML).toContain('div');
        });
    });
    describe('closeModal', () => {
    ...
    describe('createCodeSection', () => {
        it('should generate a section with provided title and content', () => {
            ...
            expect((_a = section.querySelector('h2')) === null || _a === void 0 ? void 0 : _a.textContent).toBe('Test Title');
            expect((_b = section.querySelector('.code-block')) === null || _b === void 0 ? void 0 : _b.innerHTML).toBe('<span>Content</span>');
        });
    });
});
