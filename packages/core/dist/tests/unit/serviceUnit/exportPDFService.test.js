 ...
 *   →  catch/finally runs
 */
const flushMicrotasks = () => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
const advanceAndFlush = (ms) => __awaiter(void 0, void 0, void 0, function* () {
...
describe('ExportPDFService', () => {
    ...
    it('should show a start notification immediately on click', () => {
        ...
        expect(showNotification).toHaveBeenCalledWith('Generating PDF for download...');
    });
    // -------------------------------------------------------------------------
    it('should handle errors and show error notification', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield flushMicrotasks();
        expect(showNotification).toHaveBeenCalledWith(expect.stringContaining('Error generating PDF'));
    }));
    // -------------------------------------------------------------------------
    it('should cleanup the temporary container from DOM on success', () => __awaiter(void 0, void 0, void 0, function* () {
        setupExportPDFButton();
        exportBtn.click();
        yield advanceAndFlush(1500);
        yield advanceAndFlush(100);
        yield flushMicrotasks();
        const tempContainer = document.querySelector('div[style*="left: -99999px"]');
        expect(tempContainer).toBeNull();
    }));
    // -------------------------------------------------------------------------
    it('should cleanup the temporary container from DOM on failure', () => __awaiter(void 0, void 0, void 0, function* () {
        const errorWorker = {
            set: jest.fn().mockReturnThis(),
            from: jest.fn().mockReturnThis(),
            save: jest.fn().mockRejectedValue(new Error('PDF Fail')),
    ...
    // -------------------------------------------------------------------------
    it('should call worker.set, from, and save with correct arguments', () => __awaiter(void 0, void 0, void 0, function* () {
        const mockWorker = {
            set: jest.fn().mockReturnThis(),
            from: jest.fn().mockReturnThis(),
            save: jest.fn().mockResolvedValue(true),
        ...
        yield advanceAndFlush(100);
        yield flushMicrotasks();
        expect(mockWorker.set).toHaveBeenCalledWith(expect.objectContaining({ filename: 'exported_page_download.pdf' }));
