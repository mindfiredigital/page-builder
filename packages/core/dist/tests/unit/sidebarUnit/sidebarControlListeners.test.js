 ...
 */
import { addControlListeners } from '../../../sidebar/CustomizationSidebarCore/SidebarControlListeners.js';
...
describe('addControlListeners', () => {
    ...
    describe('display', () => {
        it('maps "inline" intent to inline-block on the DOM and records the intent', () => {
            const displaySel = select('display', ['inline', 'block', 'flex'], 'block');
            addControlListeners(component, controlsContainer, addListenersFn);
        ...
        it('clears the inline intent flag for non-inline selections', () => {
            const displaySel = select('display', ['inline', 'block', 'flex'], 'inline');
    ...
    describe('flex sub-controls', () => {
        it('applies flex-direction, align-items, justify-content independently', () => {
            ...
            const align = select('align-items', ['flex-start', 'center'], 'flex-start');
            const justify = select('justify-content', ['flex-start', 'space-between'], 'flex-start');
            addControlListeners(component, controlsContainer, addListenersFn);
            dir.value = 'column';
            fire(dir, 'change');
            align.value = 'center';
