...
export class MobileResponsiveManager {
    ...
    setup(editable) {
        ...
        this.mediaQuery.addEventListener('change', () => this.onViewportChange(editable));
    }
    /* ── Backdrop ──────────────────────────────────────────────────────────── */
    createBackdrop() {
        if (document.getElementById('mobile-drawer-backdrop'))
            return;
    ...
    injectDrawerHeaders(editable) {
        ...
        if (sidebar && !sidebar.querySelector('.mobile-drawer-header')) {
            const header = this.buildDrawerHeader('Components', () => this.closeAllDrawers());
        ...
        if (customization &&
            ...
            const header = this.buildDrawerHeader('Properties', () => this.closeAllDrawers());
    ...
    createFabBar(editable) {
        if (document.getElementById('mobile-fab-bar'))
            return;
        ...
        if (editable !== false) {
            this.componentsFabBtn = this.buildFabButton('Components', FAB_ICONS.components, 'components-fab', () => this.toggleDrawer('left'));
            this.fabBar.appendChild(this.componentsFabBtn);
        }
        this.propertiesFabBtn = this.buildFabButton('Properties', FAB_ICONS.properties, 'properties-fab', () => this.toggleDrawer('right'));
    ...
    toggleDrawer(side) {
        ...
        const customization = document.getElementById('customization');
        if (side === 'left') {
            const isOpen = sidebar === null || sidebar === void 0 ? void 0 : sidebar.classList.contains('mobile-open');
            this.closeAllDrawers();
            if (!isOpen) {
                sidebar === null || sidebar === void 0 ? void 0 : sidebar.classList.add('mobile-open');
                (_a = this.backdrop) === null || _a === void 0 ? void 0 : _a.classList.add('active');
                (_b = this.componentsFabBtn) === null || _b === void 0 ? void 0 : _b.classList.add('active');
                document.body.classList.add('drawer-open');
            }
        }
        else {
            const isOpen = customization === null || customization === void 0 ? void 0 : customization.classList.contains('mobile-open');
            this.closeAllDrawers();
            if (!isOpen) {
                customization === null || customization === void 0 ? void 0 : customization.classList.add('mobile-open');
                (_c = this.backdrop) === null || _c === void 0 ? void 0 : _c.classList.add('active');
                (_d = this.propertiesFabBtn) === null || _d === void 0 ? void 0 : _d.classList.add('active');
                document.body.classList.add('drawer-open');
            }
        }
    }
    closeAllDrawers() {
        var _a, _b, _c, _d, _e;
        (_a = document.getElementById('sidebar')) === null || _a === void 0 ? void 0 : _a.classList.remove('mobile-open');
        (_b = document.getElementById('customization')) === null || _b === void 0 ? void 0 : _b.classList.remove('mobile-open');
        (_c = this.backdrop) === null || _c === void 0 ? void 0 : _c.classList.remove('active');
        (_d = this.componentsFabBtn) === null || _d === void 0 ? void 0 : _d.classList.remove('active');
        (_e = this.propertiesFabBtn) === null || _e === void 0 ? void 0 : _e.classList.remove('active');
    ...
    enableTapToAdd() {
        ...
        this.tapListenerCleanup = () => sidebar.removeEventListener('click', handler);
    }
    disableTapToAdd() {
        var _a;
        (_a = this.tapListenerCleanup) === null || _a === void 0 ? void 0 : _a.call(this);
        this.tapListenerCleanup = null;
    }
    addComponentToCanvas(componentType, customSettings) {
        var _a;
        const canvasEl = CanvasSharedState.canvasElement;
        if (!canvasEl || CanvasSharedState.editable === false)
            return;
        ...
        if (!resolvedSettings || resolvedSettings.trim() === '') {
            ...
            if ((_a = customComponents === null || customComponents === void 0 ? void 0 : customComponents[componentType]) === null || _a === void 0 ? void 0 : _a.settings) {
                resolvedSettings = JSON.stringify(customComponents[componentType].settings);
            }
        }
