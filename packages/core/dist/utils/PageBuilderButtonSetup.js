...
export function setupViewButton(htmlGenerator, layoutMode) {
    ...
    viewButton.addEventListener('click', () => {
        ...
        const canvasEl = layoutMode === 'grid' ? document.getElementById('canvas') : null;
        const canvasRect = (_a = canvasEl === null || canvasEl === void 0 ? void 0 : canvasEl.getBoundingClientRect()) !== null && _a !== void 0 ? _a : null;
        const fullScreenModal = createFullScreenPreviewModal(html, layoutMode, canvasRect);
