...
export function createAttributeControls(attribute, functionsPanel, handleInputTrigger) {
  ...
  `;
    ...
    `;
        ...
        const eventSelector = document.getElementById(`event-selector-${attribute.key}`);
        ...
        eventSelector.addEventListener('change', () => {
            ...
            (_a = eventSelector.parentElement) === null || _a === void 0 ? void 0 : _a.classList.add('trigger-changed');
            setTimeout(() => {
                var _a;
                (_a = eventSelector.parentElement) === null || _a === void 0 ? void 0 : _a.classList.remove('trigger-changed');
            }, 300);
        });
        ...
        inputElement.addEventListener('focus', () => box.classList.add('input-focused'));
        inputElement.addEventListener('blur', () => box.classList.remove('input-focused'));
    }
}
