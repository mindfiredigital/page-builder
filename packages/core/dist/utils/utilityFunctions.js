...
export function showDialogBox(message, onConfirm, onCancel) {
    ...
    yesButton === null || yesButton === void 0 ? void 0 : yesButton.addEventListener('click', () => {
        onConfirm();
        dialog === null || dialog === void 0 ? void 0 : dialog.classList.add('hidden');
    });
    noButton === null || noButton === void 0 ? void 0 : noButton.addEventListener('click', () => {
        onCancel();
        dialog === null || dialog === void 0 ? void 0 : dialog.classList.add('hidden');
    });
}
export function syntaxHighlightHTML(html) {
    return html
        ...
        .replace(/</g, '&lt;')
        .replace(/>/g, '&gt;')
        .replace(/\s([a-zA-Z-]+)="(.*?)"/g, (_match, attr, value) => ` ${attr}=<span class="attribute">"</span><span class="string">${value}</span><span class="attribute">"</span>`)
