import { createExportToZipButton } from './ExportZipService';
...
export function createCloseButton(modal: HTMLElement): HTMLButtonElement {
...
export function setupModalEventListeners(modal: HTMLElement): void {
