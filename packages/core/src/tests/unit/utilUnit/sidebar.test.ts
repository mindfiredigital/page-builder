...
jest.mock('../../../components/TextComponent', () => {
  ...
  (TextComponent as any).textAttributeConfig = {};
...
jest.mock('../../../components/HeaderComponent', () => {
  ...
  (HeaderComponent as any).headerAttributeConfig = {};
...
jest.mock('../../../components/TableComponent', () => {
  ...
  (TableComponent as any).tableAttributeConfig = {};
...
describe('createPageSizeSelect', () => {
  function makeCanvas(maxWidth?: string, minHeight?: string): HTMLElement {
...
describe('createControl', () => {
  ...
  it('renders a label with the correct text', () => {
    ...
    const label = container.querySelector('label');
    expect(label?.textContent).toContain('Width');
  });
  ...
  it('sets the input value correctly', () => {
    ...
    const input = document.getElementById('opacity') as HTMLInputElement;
  ...
  describe('number type with unit attribute', () => {
    ...
    it('appends the new unit to the value when the unit selector changes', () => {
      ...
      const input = document.getElementById('w3') as HTMLInputElement;
      const unitSelect = document.getElementById(
        'w3-unit'
      ) as HTMLSelectElement;
  ...
  describe('color type', () => {
    ...
    it('syncs hex text input when color picker changes', () => {
      ...
      const colorPicker = document.getElementById('bg2') as HTMLInputElement;
      const hexInput = document.getElementById('bg2-value') as HTMLInputElement;
    ...
    it('syncs color picker when hex text input changes', () => {
      ...
      const colorPicker = document.getElementById('bg3') as HTMLInputElement;
      const hexInput = document.getElementById('bg3-value') as HTMLInputElement;
...
describe('createSelectControl', () => {
  ...
  it('renders a label with the provided text', () => {
    ...
    expect(container.querySelector('label')?.textContent).toContain('Align');
  });
  ...
  it('pre-selects the currentValue option', () => {
    ...
    const select = document.getElementById('align5') as HTMLSelectElement;
  ...
  it('sets each option value and text to the corresponding string', () => {
    ...
    const opts = container.querySelectorAll<HTMLOptionElement>('select option');
...
describe('createAttributeControls', () => {
  ...
  it('renders a label with the attribute title', () => {
    ...
    expect(panel.querySelector('label')?.textContent).toContain('My Field');
  });
  ...
  describe('text input type (default)', () => {
    ...
    it('sets the default value on the input', () => {
      ...
      const input = document.getElementById('dv') as HTMLInputElement;
      expect(input.value).toBe('hello');
    });
  });
  ...
  describe('checkbox input type', () => {
    ...
    it('is checked when default_value is "true"', () => {
      ...
      expect(
        (document.getElementById('chk2') as HTMLInputElement).checked
      ).toBe(true);
    });
    ...
    it('is unchecked when default_value is not "true"', () => {
      ...
      expect(
        (document.getElementById('chk3') as HTMLInputElement).checked
      ).toBe(false);
    });
  });
  ...
  describe('editable = true (default)', () => {
    ...
    it('calls handleInputTrigger when the input fires the "input" event', () => {
      ...
      const input = document.getElementById('ev3') as HTMLInputElement;
    ...
    it('removes the old listener and adds the new one after selector change', () => {
      ...
      const input = document.getElementById('ev5') as HTMLInputElement;
    ...
    it('adds input-focused class on focus and removes it on blur', () => {
      ...
      const input = document.getElementById('fc1') as HTMLInputElement;
      const box = panel.querySelector(
        '.attribute-input-container'
      ) as HTMLElement;
  ...
  describe('editable = false', () => {
    ...
    it('renders the input as disabled', () => {
      ...
      const input = document.getElementById('ro2') as HTMLInputElement;
...
describe('populateModalButton', () => {
  function makeComponent(classes: string[] = ['text-component']): HTMLElement {
    const el = document.createElement('div');
  ...
  it('hides the delete button initially when no data-attribute-key is set', () => {
    const panel = makeContainer();
    populateModalButton(makeComponent(), panel, true);
    const deleteBtn = panel.querySelector<HTMLButtonElement>(
  ...
  it('clicking delete removes data-attribute-key from the component', () => {
    ...
    panel.querySelector<HTMLButtonElement>('.delete-attribute-button')!.click();
  ...
  it('clicking Set Attribute calls handleComponentClick for a text-component', async () => {
    const panel = makeContainer();
    const comp = makeComponent(['text-component']);
    populateModalButton(comp, panel, true);

    await panel
      .querySelector<HTMLButtonElement>('.set-attribute-button')!
      .click();
  ...
  it('clicking Set Attribute calls handleComponentClick for a header-component', async () => {
    const panel = makeContainer();
...
describe('populateRowVisibilityControls', () => {
  function setupFunctionsPanel(): HTMLElement {
  ...
  const INPUTS: ComponentAttribute[] = [
    {
      id: 'a1',
      key: 'income',
      title: 'Income',
  ...
  it('clicking a delete-rule button removes that rule from the row and re-renders', () => {
    ...
    const deleteButtons =
      document.querySelectorAll<HTMLButtonElement>('.delete-rule-btn');
  ...
  it('clicking a delete-rule button calls Canvas.dispatchDesignChange', () => {
    ...
    document.querySelector<HTMLButtonElement>('.delete-rule-btn')!.click();
  ...
  it('renders a rule value containing HTML as inert text, not markup (XSS regression)', () => {
    ...
    expect(ruleText.textContent).toContain(
...
describe('SidebarUtils delegation', () => {
  ...
  it('createControl delegates and produces the expected input', () => {
    ...
    expect(
      (document.getElementById('x-static') as HTMLInputElement).value
    ).toBe('val');
  });
  ...
  it('createSelectControl delegates and produces the expected select', () => {
    ...
    expect((document.getElementById('font') as HTMLSelectElement).value).toBe(
      'bold'
    );
  });
