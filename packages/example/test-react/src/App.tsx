...
const App = () => {
  ...
  const customComponents = {
    ...
    CustomRating: {
      ...
      settings: [
        { name: 'Reset Rating', functionName: 'resetRating' },
        { name: 'Set Max Rating', functionName: 'setRatingToMax' },
        { name: 'Increment Rating', functionName: 'incrementRating' },
        { name: 'Decrement Rating', functionName: 'decrementRating' },
      ],
    },
  };
